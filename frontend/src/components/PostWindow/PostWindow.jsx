             ...
             <div className="px-8 py-6 border-b border-slate-50 flex items-center justify-between bg-white shrink-0">
                <div className="flex items-center gap-4">
                   ...
                   <div className="flex flex-col">
                      <span className="text-sm font-black text-slate-900 font-jakarta uppercase tracking-tight">
                         {typeof currentPost.postedBy === 'object' ? currentPost.postedBy.name : "Anonymous Explorer"}
                      </span>
                      <span className="text-[10px] font-bold text-slate-400 font-outfit uppercase tracking-widest">
                ...
                <div className="space-y-8">
                   ...
                   <div className="space-y-4">
                      <div className="flex items-start justify-between gap-4">
                         <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase font-jakarta leading-[0.9]">
                            {currentPost.title}
                         </h2>
                         <button 
                      ...
                      <p className="text-slate-500 font-bold text-sm leading-relaxed font-outfit">
                      ...
                      <div className="p-4 rounded-[8px] bg-slate-50 border border-slate-100 flex flex-col items-center justify-center gap-3">
                         ...
                         <div className="flex items-center gap-1.5">
                            {[1,2,3,4,5].map(star => (
                               <Star 
                                 key={star} size={16}
                                 className={`cursor-pointer transition-all ${star <= (hoverRating || rating) ? 'text-teal-400 fill-teal-400 scale-125' : 'text-slate-200'}`}
                         ...
                         <span className="text-[11px] font-black text-slate-900 font-jakarta uppercase tracking-tighter">
                   ...
                   <div className="space-y-6 pt-4">
                      <div className="flex items-center justify-between">
                         <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-widest font-jakarta flex items-center gap-3">
             ...
             <div className="px-8 py-6 border-t border-slate-50 bg-white shrink-0">
                <form onSubmit={handleAddComment} className="flex items-center gap-3 bg-slate-50 border border-slate-100 p-2 rounded-[4px] group focus-within:border-slate-900 focus-within:bg-white transition-all">
                   <input 
                     ...
                     className="flex-1 bg-transparent border-none focus:ring-0 text-sm font-bold text-slate-900 placeholder:text-slate-300 font-outfit outline-none px-4"
                   />
                   <button 
  ...
  <div className="group animate-in fade-in slide-in-from-bottom-2 duration-300">
     <div className="flex items-start gap-4">
        ...
        <div className="flex-1 space-y-1">
           <div className="flex items-center justify-between">
              <span className="text-[10px] font-black text-slate-900 uppercase tracking-widest font-jakarta">
                 {comment.user?.name || "Anonymous Explorer"}
              </span>
              <span className="text-[8px] font-bold text-slate-300 uppercase font-outfit">
                 {formatDate(comment.createdAt)}
              </span>
           </div>
           <p className="text-xs font-bold text-slate-500 font-outfit leading-relaxed">
              {comment.text}
           </p>
        </div>
     </div>
