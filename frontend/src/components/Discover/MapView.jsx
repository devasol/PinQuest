  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="flex pt-32">
        ...
        {activePanel && (
          <div className="w-full lg:w-80 bg-white/90 backdrop-blur-lg shadow-xl border-r border-gray-200 z-0 flex flex-col h-full max-h-screen overflow-hidden fixed lg:relative top-32 lg:top-0">
            {/* Panel Header */}
        ...
        {/* Main Map Area */}
        <div
          className={`${activePanel ? "lg:w-1/2 w-full" : "w-full"} flex-1 relative z-0`}
        >
          <MapContainer
