...
import CommentItem from '../PostWindow/CommentItem'; // Import the new CommentItem component
    ...
    <AnimatePresence>
      ...
      >
        <div className="sidebar-window-header">
          <h2 id="post-window-title">{currentPost.title || 'Post Details'}</h2>
          <button 
            onClick={handleClose}
              ...
              <AnimatePresence>
                {showComments && (
                  <motion.div
                    ...
                    className="border-t border-gray-200 bg-gray-50 mt-4"
                  >
                    ...
                    <div className="p-4 border-t border-gray-200 bg-white">
                      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                        ...
                        <motion.button
                          ...
                          className="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg sm:rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all font-medium shadow-md text-sm"
                          whileTap={{ scale: 0.95 }}
                        >
                          Post
                        </motion.button>
...
export default SidebarPostWindow;