...
const MapIntegratedCreatePostWindow = ({
  ...
  return (
    <AnimatePresence>
      {/* full-screen wrapper so backdrop can capture clicks and block map interactions */}
      <div className="fixed inset-0 z-[10000] pointer-events-auto">
        {/* Backdrop covers entire screen and blocks map interactions */}
        <div
        ...
        <motion.div
          ...
          className="absolute bg-white rounded-xl shadow-2xl border border-gray-300 max-w-md w-[360px] sm:w-[420px] md:w-[520px] z-[10001] pointer-events-auto"
          style={{
            top: adjustedPosition.top,
            left: adjustedPosition.left,
          }}
          // stop propagation for many event types so the underlying map doesn't receive clicks/gestures
