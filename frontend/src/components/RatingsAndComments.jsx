...
const RatingsAndComments = ({ postId, isAuthenticated: authState, user }) => {
  ...
  return (
    <div className="mt-6 space-y-4">
      ...
      {/* Comments Modal */}
      {showCommentsModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-[99998] p-4">
          <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col border border-gray-200 z-[99999]">
            {/* Modal Header */}
